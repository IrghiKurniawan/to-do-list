            ...
            <div class="task-body">
                ...
                <form action="{{ route('task.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="modern-input" placeholder="Masukkan judul tugas..."
                            value="{{ old('title') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="modern-input modern-textarea" rows="4"
                            placeholder="Deskripsi tugas (opsional)...">{{ old('description') }}</textarea>
                    </div>

                    <!-- input file attachment -->
                    {{-- <div class="form-group">
                        <label for="attachment" class="modern-label">📎 Lampiran</label>
